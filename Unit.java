...
//        turns = maxTurns;
        this.step = MathUtils.random(GameController.STEP_COUNT);
        this.attack = MathUtils.random(GameController.ATTACT_COUNT);
    }
    ...
    public boolean canIMakeAction() {
        return gc.getUnitController().isItMyTurn(this) && isStayStill() && //step > 0;
                ((step > 0 ) || (attack > 0));
    }
...
//                turns--;
    ...
    public void render(SpriteBatch batch, BitmapFont font18) {
        ...
        stringHelper.append("S" + step);
        stringHelper.append("A" + attack);
